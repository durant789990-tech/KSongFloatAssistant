...
public class AutomationSettingsRepository {
    ...
    public static AutomationSettings load(Context c) {
        ...
        s.enableComment = p.getBoolean("enableComment", false);
        s.enablePrivateMessage = p.getBoolean("enablePrivateMessage", false);
        ...
        s.autoSendComment = p.getBoolean("autoSendComment", false);
        s.autoSendPrivateMessage = p.getBoolean("autoSendPrivateMessage", false);
        s.autoSend = p.getBoolean("autoSend", false);
        s.testMode = true;
